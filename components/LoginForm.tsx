  ...
  return (
    <div>
      ...
      <form onSubmit={handleLogin} className="space-y-4 sm:space-y-6">
        <div>
          <label htmlFor="loginId" className="block text-xs sm:text-sm font-bold text-gray-700 dark:text-dark-subtext mb-1">
        ...
        <div>
          <label htmlFor="password" className="block text-xs sm:text-sm font-bold text-gray-700 dark:text-dark-subtext mb-1">Password</label>
       ...
       <div className="text-center mt-6 sm:mt-8">
            <button
                ...
                className="text-xs sm:text-sm font-medium text-gray-600 dark:text-dark-subtext hover:text-primary-green dark:hover:text-dark-accent hover:underline focus:outline-none"
            >
